...
diversity.boxplot <- ggplot(data = diversity.long, mapping = aes(x = Collection.Method, y = Diversity)) +
  ...
  ylab(label = "Diversity") + 
  theme_bw()
print(richness.boxplot)
ggsave(filename = "output/figure-diversity-pairwise.png", plot = richness.boxplot)
```